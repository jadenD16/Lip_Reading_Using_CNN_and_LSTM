...
if True:
    ...
    image_dir = os.path.join(data_dir, 'C:\\Users\\Jaden\\PycharmProjects\\Thesis\\Lip_Reading_Using_CNN_and_LSTM\\images')
    annotations_dir = os.path.join(data_dir,'C:\\Users\\Jaden\\PycharmProjects\\Thesis\\Lip_Reading_Using_CNN_and_LSTM\\annotations')
