...
#     GEN_DIR = os.path.join(GRID_DIR, 'C:/Users/javinarfamily/PycharmProjects/Thesis/Lip_Reading_Using_CNN_and_LSTM/gen-images-and-words')
#
...
if 'javinarfamily' in os.getcwd():
    # voletiv
    GRID_DATA_DIR = 'D:/RawDatasets'
...
# grid_vocab list
GRID_VOCAB_LIST_FILE = os.path.join(GRID_DIR, 'C:/Users/javinarfamily/PycharmProjects/Thesis/Lip_Reading_Using_CNN_and_LSTM/grid_vocabulary.txt')
