...
# grid_vocab list
GRID_VOCAB_LIST_FILE = os.path.join(ROOT_DIR, 'C:/Users/javinarfamily/PycharmProjects/Thesis/Lip_Reading_Using_CNN_and_LSTM/grid_vocabulary.txt')
