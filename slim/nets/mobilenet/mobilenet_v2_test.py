...
from Lip_Reading_Using_CNN_and_LSTM.slim.nets.mobilenet import conv_blocks as ops
from Lip_Reading_Using_CNN_and_LSTM.slim.nets.mobilenet import mobilenet
