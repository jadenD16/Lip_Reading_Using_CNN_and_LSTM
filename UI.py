...
#
# This program is free software; you can redistribute it and/or modifyx
...
class Player(Tk.Frame):
    ...
    def scale_sel(self, evt):
        ...
        if self.timeslider_last_val != sval:
            ...
            # if the notification time (sval) is the same as the last saved time timeslider_last_val the
